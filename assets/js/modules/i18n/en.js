...
export default {
    ...
    'warn.hop_truncated_ring': '⚠ {hops} hops reach {total} hosts — only the nearest {shown} are shown, and even the first hop is incomplete.',
    'stats.col.host': 'Host',
    ...
    'app.error': 'Error: {msg}',
    'http.timeout': 'The server did not answer in time (HTTP {status}). The request was probably too large — try fewer hops or fewer host groups. The web server error log has the details.',
