...
export default {
    ...
    'table.search.placeholder': 'Suche — host:web, type:switch, port:Gi1/0/8, ...',
    'table.csv_tip':          'Die sichtbaren Zeilen als CSV — gefiltert und sortiert wie angezeigt, Ger\u00e4t und Port in eigenen Spalten',
    ...
    'table.col.uplink':       'H\u00e4ngt an',
    'table.uplink.more':      '+{n} weitere',
    'table.uplink.stale':     'zuletzt hier gesehen',
    ...
    'toolbar.cluster.needs_groups': 'Wirkt erst ab zwei Hostgruppen auf der Karte \u2014 hier gibt es nichts zu trennen.',
    ...
    'err.timeout':   'Die Anfrage hat zu lange gedauert ({code}). Die Auswahl ist vermutlich zu gro\u00df \u2014 weniger Hops oder eine kleinere Hostgruppe.',
    'err.session':   'Nicht mehr angemeldet ({code}). Seite neu laden.',
    'err.http':      'Der Server hat mit {code} geantwortet.',
    'err.not_json':  'Der Server hat keine Daten geliefert (Beginn: {start}). Meist eine Zeit\u00fcberschreitung oder eine Fehlerseite vor Zabbix.',
    'warn.scope_cut':'Nur {done} von {asked} Hops gezeigt \u2014 {hosts} Ger\u00e4te sind die Grenze f\u00fcr diese Ansicht. Weniger Hops, oder die Hostgruppen nehmen.',
    ...
    'detail.ghost.status': 'NICHT \u00dcBERWACHT',
    'detail.ghost.seen_via': 'Gesehen \u00fcber',
    'detail.ghost.seen_by': 'Gemeldet von',
    'detail.ghost.caps': 'F\u00e4higkeiten',
    'detail.ghost.desc': 'Hersteller/Modell',
    'detail.ghost.hint': 'Kein Zabbix-Host, also keine Messwerte. Alles oben stammt von dem Nachbarn, der ihn gemeldet hat.',
    ...
    'edge.metric.why_estimate': 'Es sind Ports gemeldet, aber es liessen sich keine Interface-Z\u00e4hler zuordnen. Zweierlei muss stimmen: lldpRemLocalPortNum muss dem ifIndex entsprechen \u2014 das gilt bei manchen Herstellern und bei anderen nicht \u2014 und der Host muss Interface-Items zu diesem Index haben. Die Zahlen oben sind deshalb eine Sch\u00e4tzung aus den Host-Summen, nicht dieser Port.',
    ...
    'edge.match.alias': 'der gemeldete Name ist am Host per nt:lldp erkl\u00e4rt \u2014 der Name auf dem Draht, nicht der in Zabbix.',
    ...
    'tip.ghost.seen_via': '\u00dcber',
    'tip.ghost.seen_by': 'Von',
    'tip.ghost.edge': 'F\u00fchrt zu einem Ger\u00e4t, das kein Zabbix-Host ist \u2014 hier wird nichts gemessen.',
    'tip.ghost.hint': 'Nicht \u00fcberwacht \u2014 keine eigenen Messwerte.',
    ...
    'items.needs_groups': 'Die Item-Ansicht braucht mindestens eine Hostgruppe. Im Modus Host + Hop-Radius gibt es keine — wechsle auf Hosts oder wähle oben eine Gruppe.',
    ...
    'diag.update.title':      'Update',
    'diag.update.check':      'Nach Updates suchen',
    'diag.update.idle':       'Fragt github.com einmal, wenn du den Knopf dr\u00fcckst \u2014 nie von allein.',
    'diag.update.checking':   'Frage github.com \u2026',
    'diag.update.available':  '{v} ist drau\u00dfen.',
    'diag.update.you_have':   'Installiert ist {v}.',
    'diag.update.current':    '{v} \u2014 das ist die aktuelle Version.',
    'diag.update.unreachable':'github.com ist von diesem Server aus nicht erreichbar.',
    'diag.update.open':       'Releases \u2192',
    'diag.title': 'Diagnose',
