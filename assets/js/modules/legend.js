...
export function setupLegend(groupNames, nodes) {
    ...
    let html = '<div style="font-weight:600;color:var(--nt-text-2,#475569);margin-bottom:5px;font-size:10px">'
    ...
    groupNames.forEach(function(name) {
        ...
        html += '<div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">'
              ...
              + '<span style="color:var(--nt-text-2,#475569);flex:1;font-size:11px">' + esc(name) + '</span>'
              + '<span style="color:var(--nt-muted,#94a3b8);font-size:11px">' + cnt + '</span>'
              + '</div>';
    });

    html += '<div style="font-weight:600;color:var(--nt-text-2,#475569);margin:6px 0 4px;font-size:10px;'
          + 'border-top:1px solid var(--nt-line-soft,#f1f5f9);padding-top:5px">' + esc(t('legend.severity')) + '</div>';
    SEV_LBL.forEach(function(lbl, i) {
        ...
        html += '<div style="display:flex;align-items:center;gap:6px;margin-bottom:2px">'
              ...
              + '<span style="color:var(--nt-text-2,#475569);flex:1;font-size:11px">' + lbl + '</span>'
              + '<span style="color:var(--nt-muted,#94a3b8);font-size:11px">' + cnt + '</span>'
              + '</div>';
    });

    html += '<div style="font-weight:600;color:var(--nt-text-2,#475569);margin:6px 0 4px;font-size:10px;'
          + 'border-top:1px solid var(--nt-line-soft,#f1f5f9);padding-top:5px">' + esc(t('legend.ring')) + '</div>';
    [[t('legend.ring.cpu'), '#3b82f6'], [t('legend.ring.memory'), '#8b5cf6'],
     [t('legend.ring.traffic'), '#22c55e'], [t('legend.ring.ping'), '#f59e0b']].forEach(function(r) {
        html += '<div style="display:flex;align-items:center;gap:6px;margin-bottom:2px">'
              ...
              + '<span style="color:var(--nt-text-2,#475569);font-size:11px">' + esc(r[0]) + '</span>'
              + '</div>';
    });
